  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 sm:space-y-8">
        ...
        {/* Stats Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <ThemeCard variant="elevated" className="p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                <ThemeText variant="secondary" className="text-sm font-medium">My Rooms</ThemeText>
                <ThemeText className="text-2xl sm:text-3xl font-bold">{stats.totalRooms}</ThemeText>
              </div>
          ...
          <ThemeCard variant="elevated" className="p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                <ThemeText variant="secondary" className="text-sm font-medium">Admin Rooms</ThemeText>
                <ThemeText className="text-2xl sm:text-3xl font-bold">{stats.adminRooms}</ThemeText>
              </div>
          ...
          <ThemeCard variant="elevated" className="p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                <ThemeText variant="secondary" className="text-sm font-medium">Messages</ThemeText>
                <ThemeText className="text-2xl sm:text-3xl font-bold">{stats.totalMessages}</ThemeText>
              </div>
          ...
          <ThemeCard variant="elevated" className="p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                <ThemeText variant="secondary" className="text-sm font-medium">Video Calls</ThemeText>
                <ThemeText className="text-2xl sm:text-3xl font-bold text-green-600 dark:text-green-400">Active</ThemeText>
              </div>
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-green-100 dark:bg-green-900/20 rounded-lg flex items-center justify-center">
            ...
            <div className="mt-3 sm:mt-4 flex items-center text-sm text-green-600 dark:text-green-400">
              ...
              <ThemeText variant="muted" className="text-sm text-green-600 dark:text-green-400">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <ThemeCard variant="elevated">
            <div className="p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <ThemeText as="h2" className="text-lg font-semibold">Recent Rooms</ThemeText>
                <Link 
            ...
            <div className="p-4 sm:p-6">
              {recentRooms.length > 0 ? (
                <div className="space-y-3 sm:space-y-4">
                  {recentRooms.map((room) => (
                    <Link
                      ...
                      className={`block p-3 sm:p-4 rounded-lg border ${themeClasses.nav.item} hover:border-blue-300 dark:hover:border-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors group`}
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex-1 min-w-0">
                          <ThemeText as="h3" className="font-medium truncate">{room.name}</ThemeText>
                          <div className="mt-1 flex items-center gap-2 flex-wrap">
                            <span className={`inline-flex items-center text-xs ${themeClasses.text.secondary} bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded`}>
                              {room.members.length} members
                            </span>
                            <span className={`inline-flex items-center text-xs ${room.private ? 'text-orange-700 dark:text-orange-300 bg-orange-100 dark:bg-orange-900/20' : 'text-green-700 dark:text-green-300 bg-green-100 dark:bg-green-900/20'} px-2 py-0.5 rounded`}>
                ...
                <div className="text-center py-8">
                  <MessageSquare className={`h-12 w-12 ${themeClasses.text.muted} mx-auto mb-4`} />
                  <ThemeText variant="secondary" className="mb-4">No rooms yet</ThemeText>
                  <Link href="/dashboard/create-room">
                    <ThemeButton variant="primary" size="sm" className="inline-flex items-center">
                      <Plus className="h-4 w-4 mr-2" />
          ...
          <ThemeCard variant="elevated">
            <div className="p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700">
              <ThemeText as="h2" className="text-lg font-semibold">Quick Actions</ThemeText>
            </div>
            <div className="p-4 sm:p-6">
              <div className="space-y-3 sm:space-y-4">
                <Link
                  href="/dashboard/create-room"
                  className={`flex items-center p-3 sm:p-4 rounded-lg border ${themeClasses.nav.item} hover:border-blue-300 dark:hover:border-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors`}
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <ThemeText as="h3" className="font-medium">Create Room</ThemeText>
                    <ThemeText variant="secondary" className="text-sm">Start a new workspace</ThemeText>
                  </div>
                </Link>

                <Link
                  href="/dashboard/browse"
                  className={`flex items-center p-3 sm:p-4 rounded-lg border ${themeClasses.nav.item} hover:border-green-300 dark:hover:border-green-600 hover:bg-green-50 dark:hover:bg-green-900/20 transition-colors`}
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <ThemeText as="h3" className="font-medium">Browse Rooms</ThemeText>
                    <ThemeText variant="secondary" className="text-sm">Join existing workspaces</ThemeText>
                  </div>
                </Link>

                <div className={`flex items-center p-3 sm:p-4 rounded-lg border ${themeClasses.card} bg-gray-50 dark:bg-gray-700`}>
                  ...
                  <div className="flex-1 min-w-0">
                    <ThemeText as="h3" className="font-medium text-green-600 dark:text-green-400">Video Calls</ThemeText>
                    <ThemeText className="text-sm text-green-600 dark:text-green-400">Available in rooms</ThemeText>
                  </div>
                </div>
              </div>
            </div>
